...
export default function Form({ customers }: { customers: CustomerField[] }) {
  ...
  const SubmitButton = () => {
    ...
    if (pending) {
      return <Button type="submit" disabled={true} className="bg-blue-200 hover:bg-blue-200 active:bg-blue-200">Loading...</Button>
    }
    return <Button type="submit">Create Invoice</Button>
  }
  return (
